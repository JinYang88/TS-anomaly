...
def get_settings(pattern):
    ...
    settings["identifier"] = "smd_train_machine_1_1"
    settings["sub_id"] = "smd_train_machine_1_1"
    settings["dp"] = False
...
if __name__ == "__main__":
    ...
    idx = np.asarray(list(range(0, 28479+stride*window_size)))
    ...
    detect(samples,labels,index,settings)