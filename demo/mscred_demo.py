...
if __name__ == "__main__":
    ...
    torch.save(mscred.state_dict(), './mscred_data/checkpoints/model-' + subdataset + '.pth')

    # 测试阶段
    mscred.load_state_dict(torch.load('./mscred_data/checkpoints/model-' + subdataset + '.pth'))
    mscred.to(device)
