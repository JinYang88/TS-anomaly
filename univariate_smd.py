...
# python univariate_smd.py --path ./datasets/SMD/processed --dataset machine-1-1 --save_path ./checkpoints --hyper default_hyperparameters.json 
...
if __name__ == '__main__':
    ...
    test_windows = BatchSlidingWindow(test.shape[0],window_size=encoder.window_size, batch_size=encoder.batch_size).get_iterator(test)
