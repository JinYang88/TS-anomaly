...
python KNN_benchmark.py --dataset SWAT_SPLIT --n_neighbors 30
...
python LOF_benchmark.py --dataset SWAT_SPLIT --n_neighbors 3
...
python PCA_benchmark.py --dataset WADI --n_components 10