...
# rerun 时间
CUDA_VISIBLE_DEVICES=0 python dagmm_benchmark.py --dataset WADI --lr 0.0001 --dropout 0.25 --num_epochs 100 -ch 128 64 2 -eh 100 50 > logs/rerun_time_dagmm.log 2>&1 &

CUDA_VISIBLE_DEVICES=1 python lstm_vae_benchmark.py --dataset WADI --lr 0.001 --z_dim 3 --intermediate_dim 64 --window_size 32 --stride 5 --hidden_size 128 --num_epochs 40 > logs/rerun_time_lstm_vae.log 2>&1 &
